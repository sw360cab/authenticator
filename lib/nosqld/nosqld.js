 ...
 */
Nosqld.prototype.configure = function (dbms,dbName) {
  if (dbms === "couchd")
...
Nosqld.prototype.init = function (theDb) {
  return this.dbms.init(theDb);
};
...
Nosqld.prototype.query = function (dataToQuery,callback) { 
  return this.dbms.query(dataToQuery,callback);
};
